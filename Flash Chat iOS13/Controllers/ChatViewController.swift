...
class ChatViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        title = K.appName
        navigationItem.hidesBackButton = true // charviewde back butonu gizledik.
...
extension ChatViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return messages.count // messages arrayinde kac mesaj varsa o kadar
    }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        //identifiy cell bu kim ne is yapar hangi cell bu cell falan indexi nasil alcak
        let cell = tableView.dequeueReusableCell(withIdentifier: K.cellIdentifier , for: indexPath) as! MessageCell
        // celle datalarini verelim.
        ...
        // this is a message from the diffirent sender
        if message.sender != Auth.auth().currentUser?.email {
